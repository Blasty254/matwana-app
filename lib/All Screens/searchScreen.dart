...
import 'package:matwana_app/Models/placePredictions.dart';
      ...
      if(res["status"] == "OK")
        {
          ...
          var placesLists = (predictions as List).map((e) => PlacePredictions.fromJson(e)).toList();

          setState(() {
            placePredictionsList = placesLists;
          });
        }
    }
